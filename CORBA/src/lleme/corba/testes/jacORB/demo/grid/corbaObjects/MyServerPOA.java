...
public abstract class MyServerPOA extends org.omg.PortableServer.Servant
		...
		lleme.corba.testes.jacORB.demo.grid.corbaObjects.MyServerOperations {
	...
	public org.omg.CORBA.portable.OutputStream _invoke(String method,
		...
		case 1: // opWithException
		{
			...
			} catch (lleme.corba.testes.jacORB.demo.grid.corbaObjects.MyServerPackage.MyException _ex0) {
		...
		case 2: // set
		{
			...
			java.math.BigDecimal _arg2 = lleme.corba.testes.jacORB.demo.grid.corbaObjects.MyServerPackage.fixedTHelper
					.read(_input);
			_out = handler.createReply();

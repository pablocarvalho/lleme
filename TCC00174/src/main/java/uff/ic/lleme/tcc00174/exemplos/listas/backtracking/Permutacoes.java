package uff.ic.lleme.tcc00174.exemplos.listas.backtracking;

import static uff.ic.lleme.tcc00174.exemplos.listas.backtracking.Subconjuntos.backtrack;

public class Permutacoes {

  private static boolean finished = false; /* Todas solu��es encontradas? */

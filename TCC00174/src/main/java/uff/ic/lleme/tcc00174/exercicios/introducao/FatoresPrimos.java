package uff.ic.lleme.tcc00174.exercicios.introducao;

/**
 * Programacao de computadores II TCC-00174 Aula 1 - Introducao ao Java,
 * Exerc�cios. Fatores Primos
 *
...
public class FatoresPrimos {
  ...
  /**
   * Vers�o simples para o calculo dos fatores primos.
   *
  ...
  /**
   * Vers�o eficiente para o calculo dos fatores primos.
   *
   * @param number numero que desejamos fatorar.
   */

...
import model.Heap;
import model.ListaDeAtendimentos;
import model.ListaDeAtendimentosEncerrados;
import model.TipoAssunto;
...
public class ServicoDeAtendimento {
	...
	private static int calculaDuracaoAtendimento( Calendar inicio, Calendar fim )
	{
		...
		{
			/**
			 * Para simplificação da lógica, caso um atendimento tenha sido encerrado X dias após o dia em que o mesmo foi iniciado,

 ...
 * @param <E>
 */
public class LinkedList<E extends uff.ic.lleme.tic10002.trabalhos._20171.danielpinheiro.Comparable<E>> implements List<E> {

    int length;
    Node first;
    Node last;

    class Node<E extends uff.ic.lleme.tic10002.trabalhos._20171.danielpinheiro.Comparable<E>> {

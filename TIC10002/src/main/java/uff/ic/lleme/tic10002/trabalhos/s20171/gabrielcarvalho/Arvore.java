...
public class Arvore {
    ...
    private int busca(No atual, int filialMenor, int filialMaior, MesAno dataMenor, MesAno dataMaior) {
        if (atual != null) {
            if (atual.getChave() < filialMenor)
                return busca(atual.dir, filialMenor, filialMaior, dataMenor, dataMaior);
            if (atual.getChave() > filialMaior)
                return busca(atual.esq, filialMenor, filialMaior, dataMenor, dataMaior);
    ...
    /**
     * @param imprimir é igual a 0 se for para imprimir a árvore e a sub árvore,
     * 1 se for só a árvore e 2 se for só as sub árvores
     */

package uff.ic.lleme.tic10002.provas.s20171.VS20171Q1;

import java.util.Arrays;

public class VS20171Q1 {

    private static int[] chaves = {2, 17, 34, 56, 65};
    private static double[] f = {0, 1, 2, 3, 1, 4};
    private static double[] f2 = {0, 1, 2, 4, 1, 1};

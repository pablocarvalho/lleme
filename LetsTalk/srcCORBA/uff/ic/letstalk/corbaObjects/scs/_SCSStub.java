...
public class _SCSStub extends org.omg.CORBA.portable.ObjectImpl implements
		uff.ic.letstalk.corbaObjects.scs.SCS {

	public uff.ic.letstalk.corbaObjects.scs.IComponent getIComponent(String className)
			throws uff.ic.letstalk.corbaObjects.scs.InternalError {
	...
	public uff.ic.letstalk.corbaObjects.scs.IComponent releaseIComponent(String className) {
		org.omg.CORBA.portable.InputStream $in = null;
		try {
			org.omg.CORBA.portable.OutputStream $out = _request(

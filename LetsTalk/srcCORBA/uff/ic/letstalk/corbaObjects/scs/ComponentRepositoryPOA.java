...
public abstract class ComponentRepositoryPOA extends
		...
		uff.ic.letstalk.corbaObjects.scs.ComponentRepositoryOperations,
	...
	public org.omg.CORBA.portable.OutputStream _invoke(String $method,
		...
		case 0: // corbaObjects/scs/ComponentRepository/install
		{
			try {
				...
				byte file[] = uff.ic.letstalk.corbaObjects.scs.OctetSeqHelper.read(in);
				String help_info = in.read_string();
				this.install(id, entry_point, shared, file, help_info);
				out = $rh.createReply();
			} catch (uff.ic.letstalk.corbaObjects.scs.ComponentAlreadyInstalled $ex) {
				out = $rh.createExceptionReply();
				uff.ic.letstalk.corbaObjects.scs.ComponentAlreadyInstalledHelper
						.write(out, $ex);
			} catch (uff.ic.letstalk.corbaObjects.scs.IOException $ex) {
				out = $rh.createExceptionReply();
				uff.ic.letstalk.corbaObjects.scs.IOExceptionHelper.write(out, $ex);
			}
			break;
		}
		...
		case 1: // corbaObjects/scs/ComponentRepository/uninstall
		{
			try {
				...
				this.uninstall(id);
				out = $rh.createReply();
			} catch (uff.ic.letstalk.corbaObjects.scs.ComponentNotInstalled $ex) {
				out = $rh.createExceptionReply();
				uff.ic.letstalk.corbaObjects.scs.ComponentNotInstalledHelper.write(out, $ex);
			} catch (uff.ic.letstalk.corbaObjects.scs.IOException $ex) {
				out = $rh.createExceptionReply();
				uff.ic.letstalk.corbaObjects.scs.IOExceptionHelper.write(out, $ex);
			}
		...
		case 2: // corbaObjects/scs/ComponentRepository/copy
		{
			try {
				uff.ic.letstalk.corbaObjects.scs.ComponentId id = uff.ic.letstalk.corbaObjects.scs.ComponentIdHelper
						.read(in);
				uff.ic.letstalk.corbaObjects.scs.ComponentRepository rep = uff.ic.letstalk.corbaObjects.scs.ComponentRepositoryHelper
						.read(in);
				this.copy(id, rep);
				out = $rh.createReply();
			} catch (uff.ic.letstalk.corbaObjects.scs.ComponentAlreadyInstalled $ex) {
		...
		case 3: // corbaObjects/scs/ComponentRepository/getComponentFile
		{
			try {
				...
				out = $rh.createReply();
				uff.ic.letstalk.corbaObjects.scs.OctetSeqHelper.write(out, $result);
			} catch (uff.ic.letstalk.corbaObjects.scs.ComponentNotInstalled $ex) {
				out = $rh.createExceptionReply();
				uff.ic.letstalk.corbaObjects.scs.ComponentNotInstalledHelper.write(out, $ex);
			} catch (uff.ic.letstalk.corbaObjects.scs.IOException $ex) {
		...
		case 4: // corbaObjects/scs/ComponentRepository/getComponentDescription
		{
			try {
				uff.ic.letstalk.corbaObjects.scs.ComponentId id = uff.ic.letstalk.corbaObjects.scs.ComponentIdHelper
						.read(in);
				uff.ic.letstalk.corbaObjects.scs.ComponentDescription $result = null;
				$result = this.getComponentDescription(id);
				out = $rh.createReply();
				uff.ic.letstalk.corbaObjects.scs.ComponentDescriptionHelper.write(out, $result);
			} catch (uff.ic.letstalk.corbaObjects.scs.ComponentNotInstalled $ex) {
				out = $rh.createExceptionReply();
				uff.ic.letstalk.corbaObjects.scs.ComponentNotInstalledHelper.write(out, $ex);
			}
		...
		case 5: // corbaObjects/scs/ComponentRepository/getInstalledComponents
		{
			...
			out = $rh.createReply();
			uff.ic.letstalk.corbaObjects.scs.ComponentDescriptionSeqHelper.write(out, $result);
			break;
		}

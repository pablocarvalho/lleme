...
public class _IComponentStub extends org.omg.CORBA.portable.ObjectImpl
        implements uff.ic.letstalk.corbaObjects.scs.IComponent {
    ...
    public org.omg.CORBA.Object getFacet(String facet_interface)
        ...
        try {
            ...
            if (_id.equals("IDL:corbaObjects/scs/InvalidName:1.0"))
                throw uff.ic.letstalk.corbaObjects.scs.InvalidNameHelper.read($in);
    ...
    public void startup() throws uff.ic.letstalk.corbaObjects.scs.StartupFailed {
        org.omg.CORBA.portable.InputStream $in = null;
        try {
            ...
            if (_id.equals("IDL:corbaObjects/scs/StartupFailed:1.0"))
                throw uff.ic.letstalk.corbaObjects.scs.StartupFailedHelper.read($in);
            throw new org.omg.CORBA.MARSHAL(_id);
        } catch (org.omg.CORBA.portable.RemarshalException $rm) {
            startup();
        } finally {
    ...
    public void shutdown() throws uff.ic.letstalk.corbaObjects.scs.ShutdownFailed {
        org.omg.CORBA.portable.InputStream $in = null;
        try {
            ...
            if (_id.equals("IDL:corbaObjects/scs/ShutdownFailed:1.0"))
                throw uff.ic.letstalk.corbaObjects.scs.ShutdownFailedHelper.read($in);
            throw new org.omg.CORBA.MARSHAL(_id);
        } catch (org.omg.CORBA.portable.RemarshalException $rm) {
            shutdown();
        } finally {
    ...
    public int connect(String receptacle, org.omg.CORBA.Object obj)
        ...
        try {
            ...
            $in = _invoke($out);
            int $result = uff.ic.letstalk.corbaObjects.scs.ConnectionIdHelper.read($in);
            return $result;
        } catch (org.omg.CORBA.portable.ApplicationException $ex) {
            $in = $ex.getInputStream();
            String _id = $ex.getId();
            if (_id.equals("IDL:corbaObjects/scs/InvalidName:1.0"))
                ...
                throw uff.ic.letstalk.corbaObjects.scs.InvalidConnectionHelper.read($in);
            else if (_id.equals("IDL:corbaObjects/scs/AlreadyConnected:1.0"))
                throw uff.ic.letstalk.corbaObjects.scs.AlreadyConnectedHelper.read($in);
            else if (_id
                    .equals("IDL:corbaObjects/scs/ExceededConnectionLimit:1.0"))
                throw uff.ic.letstalk.corbaObjects.scs.ExceededConnectionLimitHelper.read($in);
            else
                throw new org.omg.CORBA.MARSHAL(_id);
        } catch (org.omg.CORBA.portable.RemarshalException $rm) {
    ...
    public void disconnect(int id) throws uff.ic.letstalk.corbaObjects.scs.InvalidConnection,
            uff.ic.letstalk.corbaObjects.scs.NoConnection {
        org.omg.CORBA.portable.InputStream $in = null;
        try {
            org.omg.CORBA.portable.OutputStream $out = _request("disconnect",
                    true);
            uff.ic.letstalk.corbaObjects.scs.ConnectionIdHelper.write($out, id);
            $in = _invoke($out);
            return;
        } catch (org.omg.CORBA.portable.ApplicationException $ex) {
            $in = $ex.getInputStream();
            ...
            if (_id.equals("IDL:corbaObjects/scs/InvalidConnection:1.0"))
                ...
                throw uff.ic.letstalk.corbaObjects.scs.NoConnectionHelper.read($in);
            else
                throw new org.omg.CORBA.MARSHAL(_id);
        } catch (org.omg.CORBA.portable.RemarshalException $rm) {
            disconnect(id);
    ...
    public uff.ic.letstalk.corbaObjects.scs.ConnectionDescription getConnection(int id)
        ...
        try {
            ...
            uff.ic.letstalk.corbaObjects.scs.ConnectionIdHelper.write($out, id);
            $in = _invoke($out);
            uff.ic.letstalk.corbaObjects.scs.ConnectionDescription $result = uff.ic.letstalk.corbaObjects.scs.ConnectionDescriptionHelper
                    .read($in);
            return $result;
        } catch (org.omg.CORBA.portable.ApplicationException $ex) {
            $in = $ex.getInputStream();
    ...
    public uff.ic.letstalk.corbaObjects.scs.ConnectionDescription[] getConnections(
            String receptacle) throws uff.ic.letstalk.corbaObjects.scs.InvalidName {
        org.omg.CORBA.portable.InputStream $in = null;
        try {
            org.omg.CORBA.portable.OutputStream $out = _request(
                    "getConnections", true);
            $out.write_string(receptacle);
            $in = _invoke($out);
            uff.ic.letstalk.corbaObjects.scs.ConnectionDescription $result[] = uff.ic.letstalk.corbaObjects.scs.ConnectionDescriptionsHelper
                    .read($in);
            return $result;
        } catch (org.omg.CORBA.portable.ApplicationException $ex) {
            $in = $ex.getInputStream();
    ...
    // MetaInterface
    public uff.ic.letstalk.corbaObjects.scs.FacetDescription[] getFacets() {
        org.omg.CORBA.portable.InputStream $in = null;
        try {
            org.omg.CORBA.portable.OutputStream $out = _request("getFacets",
                    true);
            $in = _invoke($out);
            uff.ic.letstalk.corbaObjects.scs.FacetDescription $result[] = uff.ic.letstalk.corbaObjects.scs.FacetDescriptionsHelper
                    .read($in);
            return $result;
        } catch (org.omg.CORBA.portable.ApplicationException $ex) {
            $in = $ex.getInputStream();
    ...
    public uff.ic.letstalk.corbaObjects.scs.FacetDescription[] getFacetsByName(String[] names)
            throws uff.ic.letstalk.corbaObjects.scs.InvalidName {
        org.omg.CORBA.portable.InputStream $in = null;
        try {
            org.omg.CORBA.portable.OutputStream $out = _request(
                    "getFacetsByName", true);
            uff.ic.letstalk.corbaObjects.scs.NameListHelper.write($out, names);
            $in = _invoke($out);
            uff.ic.letstalk.corbaObjects.scs.FacetDescription $result[] = uff.ic.letstalk.corbaObjects.scs.FacetDescriptionsHelper
                    .read($in);
            return $result;
    ...
    public uff.ic.letstalk.corbaObjects.scs.ReceptacleDescription[] getReceptacles() {
        org.omg.CORBA.portable.InputStream $in = null;
        try {
            org.omg.CORBA.portable.OutputStream $out = _request(
                    "getReceptacles", true);
            $in = _invoke($out);
            uff.ic.letstalk.corbaObjects.scs.ReceptacleDescription $result[] = uff.ic.letstalk.corbaObjects.scs.ReceptacleDescriptionsHelper
                    .read($in);
            return $result;
        } catch (org.omg.CORBA.portable.ApplicationException $ex) {
            $in = $ex.getInputStream();
    ...
    public uff.ic.letstalk.corbaObjects.scs.ConnectionDescription[] getReceptacleConnections(
        ...
        try {
            ...
            if (_id.equals("IDL:corbaObjects/scs/InvalidName:1.0"))
                ...
                throw uff.ic.letstalk.corbaObjects.scs.InternalErrorHelper.read($in);
            else
                throw new org.omg.CORBA.MARSHAL(_id);
        } catch (org.omg.CORBA.portable.RemarshalException $rm) {
    ...
    public uff.ic.letstalk.corbaObjects.scs.ReceptacleDescription[] getReceptaclesByName(
            String[] names) throws uff.ic.letstalk.corbaObjects.scs.InvalidName {
        org.omg.CORBA.portable.InputStream $in = null;
        try {
            org.omg.CORBA.portable.OutputStream $out = _request(

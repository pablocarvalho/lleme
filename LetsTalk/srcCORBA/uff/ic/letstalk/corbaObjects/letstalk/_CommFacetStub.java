...
public class _CommFacetStub extends org.omg.CORBA.portable.ObjectImpl implements
		uff.ic.letstalk.corbaObjects.letstalk.CommFacet {
	...
	public void startChatting(String login, String[] users)
		...
		try {
			...
			uff.ic.letstalk.corbaObjects.letstalk.stringListHelper.write($out, users);
			$in = _invoke($out);
			return;
	...
	public void sendMessage(String login, String chatId, String[] recipients,
		...
		try {
			...
			uff.ic.letstalk.corbaObjects.letstalk.stringListHelper.write($out, recipients);

...
public abstract class UserManagerFacetPOA extends
		...
		uff.ic.letstalk.corbaObjects.letstalk.usermanager.UserManagerFacetOperations,
	...
	public org.omg.CORBA.portable.OutputStream _invoke(String $method,
		...
		case 0: // corbaObjects/letstalk/usermanager/UserManagerFacet/subscribe
		{
			...
			uff.ic.letstalk.corbaObjects.letstalk.usermanager.enum_type $result = null;
			$result = this.subscribe(login, password);
			out = $rh.createReply();
			uff.ic.letstalk.corbaObjects.letstalk.usermanager.enum_typeHelper.write(out,
					$result);
			break;
		}

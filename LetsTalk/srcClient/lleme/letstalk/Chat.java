...
public class Chat extends JDialog {
    ...
    // ************************************
    // Luiz Andr� - alterei visibilidade
    //
    ...
    public Chat(String chatId, String[] userIds) {
        // ************************************
        // Luiz Andr� - alterei o nome da janela
        // e inclui o chatId
        //
        // super("Lets Talk");
        this.chatId = chatId;
        ...
        fimMens = 0;
        // ************************************
        // Luiz Andr� - desabilitei os bot�es de conex�o
        //
        // criar bot�es conectar e disconectar
        // btCNok = criarBot�o("Conectar", 0, 0, 3, 1);
        // btCNok.setEnabled(true);
        // btDCok = criarBot�o("Desconectar", 1, 0, 3, 1);
        // ************************************
        // lista de destinatarios
        JTextField tfLU = new JTextField("        Lista de Usuarios  ");
        tfLU.setBorder(null);
        tfLU.setEditable(false);
        addComponent(tfLU, 2, 0, 3, 1);
        itemList = criarLista(userIds, 3, 0, 3, 3);
        // ************************************
        // Luiz Andr� - alterei modelo da lista
        //
        ...
        // ************************************
        // Luiz Andr� - alterei nome do bot�o
        //
        btICok.setText("Incluir userId");
        // ************************************
        // lista de destinatarios
        JTextField tfLD = new JTextField("   Lista de Destinatarios");
        tfLD.setBorder(null);
        ...
        // ************************************
        // ************************************
        // Luiz Andr� - comentei essas linhas
        //
        // btSEok = criarBot�o("Inscrever no Chat", 13, 0, 3, 1);
        ...
        // ************************************
        // Luiz Andr� - habilitei mensagens
        //
        mensEnvList.setEnabled(true);
        // ************************************
        // ==Listeners do bot�es=========================================
        // a��es do bot�o Enviar mensagem
        btEMok.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                /*
				 * Luiz Andr� - desabilitei este trecho
				 *
		 ...
		 * true; } });
         */
        // a��es do bot�o desconectar
        /*
		 * btDCok.addActionListener(new ActionListener() { public void
		 * actionPerformed(ActionEvent e) { // inserir a��es
    ...
    private JList criarLista(String[] nomes, int lin, int col, int comp, int alt) {
        // ***********************************
        // Luiz Andr� - constru��o da lista sem par�metros

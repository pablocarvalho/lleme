/**
 * ConnectionIdHelper.java . Generated by the IDL-to-Java compiler (portable),
 * version "3.2" from scs.idl Friday, December 9, 2005 9:35:21 PM GMT
 */

abstract public class ConnectionIdHelper {
	private static String _id = "IDL:ConnectionId:1.0";
	...
	synchronized public static org.omg.CORBA.TypeCode type() {
		if (__typeCode == null) {
			...
			__typeCode = org.omg.CORBA.ORB.init().create_alias_tc(
					ConnectionIdHelper.id(), "ConnectionId", __typeCode);
		}
		return __typeCode;
	}

...
public class ExecutionNodeComponentServant extends IComponentPOA {
	...
	public ExecutionNodeComponentServant(ORB orb) throws ServantNotActive,
		...
		facet.name = "ExecutionNodeFacet";
		facet.interface_name = "ExecutionNode";
		ExecutionNodeServant executionNodeServant = new ExecutionNodeServant();
		facet.facet_ref = poa.servant_to_reference(executionNodeServant);
		facetsByName.put(facet.name, facet);
		facetsByInterface.put(facet.interface_name, facet);

		System.out
				.println("ExecutionNodeComponentServant:Faceta ExecutionNodeFacet montada");

/**
 * ComponentIdHelper.java . Generated by the IDL-to-Java compiler (portable),
 * version "3.2" from deployment.idl Saturday, December 10, 2005 1:24:06 AM GMT
 */

abstract public class ComponentIdHelper {
	private static String _id = "IDL:ComponentId/ComponentId:1.0";
			...
			synchronized (org.omg.CORBA.TypeCode.class) {
				if (__typeCode == null) {
					...
					__typeCode = org.omg.CORBA.ORB.init().create_struct_tc(
							ComponentIdHelper.id(), "ComponentId", _members0);
					__active = false;
				}
			}
		}

/**
 * IComponentHelper.java . Generated by the IDL-to-Java compiler (portable),
 * version "3.2" from scs.idl Friday, December 9, 2005 9:35:21 PM GMT
 */

abstract public class IComponentHelper {
	private static String _id = "IDL:IComponent:1.0";
	...
	synchronized public static org.omg.CORBA.TypeCode type() {
		if (__typeCode == null) {
			__typeCode = org.omg.CORBA.ORB.init().create_interface_tc(
					IComponentHelper.id(), "IComponent");
		}
		return __typeCode;
	}
	...
	public static IComponent narrow(org.omg.CORBA.Object obj) {
		if (obj == null)
			return null;
			...
			org.omg.CORBA.portable.Delegate delegate = ((org.omg.CORBA.portable.ObjectImpl) obj)
					._get_delegate();
			_IComponentStub stub = new _IComponentStub();
			stub._set_delegate(delegate);
			return stub;
		}
	}

	public static IComponent unchecked_narrow(org.omg.CORBA.Object obj) {
		if (obj == null)
			return null;
		else if (obj instanceof IComponent)
			return (IComponent) obj;

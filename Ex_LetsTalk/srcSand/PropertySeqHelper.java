/**
 * PropertySeqHelper.java . Generated by the IDL-to-Java compiler (portable),
 * version "3.2" from deployment.idl Saturday, December 10, 2005 1:24:06 AM GMT
 */

abstract public class PropertySeqHelper {
	private static String _id = "IDL:PropertySeq:1.0";
	...
	synchronized public static org.omg.CORBA.TypeCode type() {
		if (__typeCode == null) {
			...
			__typeCode = org.omg.CORBA.ORB.init().create_alias_tc(
					PropertySeqHelper.id(), "PropertySeq", __typeCode);
		}
		return __typeCode;
	}

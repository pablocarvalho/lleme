/**
 * ConnectionDescriptionHelper.java . Generated by the IDL-to-Java compiler
 * (portable), version "3.2" from scs.idl Friday, December 9, 2005 9:35:21 PM
 * GMT
 */

abstract public class ConnectionDescriptionHelper {
	private static String _id = "IDL:ConnectionDescription/ConnectionDescription:1.0";
			...
			synchronized (org.omg.CORBA.TypeCode.class) {
				if (__typeCode == null) {
					...
					_tcOf_members0 = org.omg.CORBA.ORB.init().create_alias_tc(
							ConnectionIdHelper.id(), "ConnectionId",
							_tcOf_members0);
	...
	public static ConnectionDescription read(
		...
		ConnectionDescription value = new ConnectionDescription();

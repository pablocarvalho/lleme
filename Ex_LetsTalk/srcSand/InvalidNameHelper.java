/**
 * InvalidNameHelper.java . Generated by the IDL-to-Java compiler (portable),
 * version "3.2" from scs.idl Friday, December 9, 2005 9:35:21 PM GMT
 */

abstract public class InvalidNameHelper {
	private static String _id = "IDL:InvalidName:1.0";
			...
			synchronized (org.omg.CORBA.TypeCode.class) {
				if (__typeCode == null) {
					...
					__typeCode = org.omg.CORBA.ORB.init().create_exception_tc(
							InvalidNameHelper.id(), "InvalidName", _members0);
					__active = false;
				}
			}
		}

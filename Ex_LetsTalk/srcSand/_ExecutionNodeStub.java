/**
 * _ExecutionNodeStub.java . Generated by the IDL-to-Java compiler (portable),
	...
	public void startContainer(ContainerDescription container) {
		...
		try {
			org.omg.CORBA.portable.OutputStream $out = _request(
					"startContainer", true);
			ContainerDescriptionHelper.write($out, container);
			$in = _invoke($out);
			return;
		} catch (org.omg.CORBA.portable.ApplicationException $ex) {
			$in = $ex.getInputStream();
	...
	public ContainerDescription[] getContainers() {
		...
		try {
			org.omg.CORBA.portable.OutputStream $out = _request(
					"getContainers", true);
			$in = _invoke($out);
			ContainerDescription $result[] = ContainerDescriptionSeqHelper
					.read($in);
			return $result;
		} catch (org.omg.CORBA.portable.ApplicationException $ex) {
			$in = $ex.getInputStream();

...
import uff.ic.lleme.letstalk.cbobjs.corbaObjects.scs.NodeLookupHelper;
...
public class RegistryStarter extends JFrame implements Runnable {
	...
	public void startComponent() {
		...
		try {
			...
			uff.ic.lleme.letstalk.regold.scs.RegistryServant servant = new uff.ic.lleme.letstalk.regold.scs.RegistryServant(
					myOrb, this);

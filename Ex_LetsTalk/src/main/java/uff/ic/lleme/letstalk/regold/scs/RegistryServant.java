...
import uff.ic.lleme.letstalk.cbobjs.corbaObjects.scs.NodeLookup;
...
public class RegistryServant extends IComponentPOAImpl {
    ...
    private void initialize(ORB orb, RegistryStarter starter)
        ...
        uff.ic.lleme.letstalk.regold.scs.NodeRegisterServant facet1Servant = null;
        if (starter == null)
            facet1Servant = new NodeRegisterServant();
        else
            facet1Servant = new NodeRegisterServant(starter);
        ...
        uff.ic.lleme.letstalk.regold.scs.NodeLookupServant facet2Servant = new NodeLookupServant(
                facet1Servant);

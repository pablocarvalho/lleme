...
/**
 * corbaObjects/scs/StringSeqHelper.java . Generated by the IDL-to-Java compiler
...
abstract public class StringSeqHelper {
	private static String _id = "IDL:corbaObjects/scs/StringSeq:1.0";
	...
	synchronized public static org.omg.CORBA.TypeCode type() {
		if (__typeCode == null) {
			...
			__typeCode = org.omg.CORBA.ORB.init().create_sequence_tc(0,
					__typeCode);
			__typeCode = org.omg.CORBA.ORB.init().create_alias_tc(uff.ic.lleme.letstalk.cbobjs.corbaObjects.scs.StringSeqHelper.id(), "StringSeq",
					__typeCode);
		}
		return __typeCode;
	}

...
public class _SCSStub extends org.omg.CORBA.portable.ObjectImpl implements
		uff.ic.lleme.letstalk.cbobjs.corbaObjects.scs.SCS {

	public uff.ic.lleme.letstalk.cbobjs.corbaObjects.scs.IComponent getIComponent(String className)
	...
	public uff.ic.lleme.letstalk.cbobjs.corbaObjects.scs.IComponent releaseIComponent(String className) {
		org.omg.CORBA.portable.InputStream $in = null;
		try {
			org.omg.CORBA.portable.OutputStream $out = _request(

...
public abstract class NodeLookupPOA extends org.omg.PortableServer.Servant
		implements uff.ic.lleme.letstalk.cbobjs.corbaObjects.scs.NodeLookupOperations,
	...
	public org.omg.CORBA.portable.OutputStream _invoke(String $method,
		...
		case 0: // corbaObjects/scs/NodeLookup/getNode
		{
			...
			uff.ic.lleme.letstalk.cbobjs.corbaObjects.scs.NodeDescription $result = null;
			$result = this.getNode(name);
			out = $rh.createReply();
			uff.ic.lleme.letstalk.cbobjs.corbaObjects.scs.NodeDescriptionHelper.write(out, $result);
			break;
		}

		case 1: // corbaObjects/scs/NodeLookup/getNodes
		{
			uff.ic.lleme.letstalk.cbobjs.corbaObjects.scs.Property props[] = uff.ic.lleme.letstalk.cbobjs.corbaObjects.scs.PropertySeqHelper
					.read(in);
			uff.ic.lleme.letstalk.cbobjs.corbaObjects.scs.NodeDescription $result[] = null;
			$result = this.getNodes(props);
			out = $rh.createReply();
			uff.ic.lleme.letstalk.cbobjs.corbaObjects.scs.NodeDescriptionSeqHelper.write(out, $result);
			break;
		}

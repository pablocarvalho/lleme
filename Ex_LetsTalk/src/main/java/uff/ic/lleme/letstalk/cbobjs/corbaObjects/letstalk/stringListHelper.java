...
/**
 * corbaObjects/letstalk/stringListHelper.java . Generated by the IDL-to-Java
...
abstract public class stringListHelper {
	private static String _id = "IDL:corbaObjects/letstalk/stringList:1.0";
	...
	synchronized public static org.omg.CORBA.TypeCode type() {
		if (__typeCode == null) {
			...
			__typeCode = org.omg.CORBA.ORB.init().create_sequence_tc(0,
					__typeCode);
			__typeCode = org.omg.CORBA.ORB.init().create_alias_tc(uff.ic.lleme.letstalk.cbobjs.corbaObjects.letstalk.stringListHelper.id(), "stringList",
					__typeCode);
		}
		return __typeCode;
	}

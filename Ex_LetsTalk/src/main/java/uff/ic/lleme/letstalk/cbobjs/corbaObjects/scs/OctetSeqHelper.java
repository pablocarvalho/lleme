...
/**
 * corbaObjects/scs/OctetSeqHelper.java . Generated by the IDL-to-Java compiler
...
abstract public class OctetSeqHelper {
	private static String _id = "IDL:corbaObjects/scs/OctetSeq:1.0";
	...
	synchronized public static org.omg.CORBA.TypeCode type() {
		if (__typeCode == null) {
			...
			__typeCode = org.omg.CORBA.ORB.init().create_sequence_tc(0,
					__typeCode);
			__typeCode = org.omg.CORBA.ORB.init().create_alias_tc(uff.ic.lleme.letstalk.cbobjs.corbaObjects.scs.OctetSeqHelper.id(), "OctetSeq",
					__typeCode);
		}
		return __typeCode;
	}

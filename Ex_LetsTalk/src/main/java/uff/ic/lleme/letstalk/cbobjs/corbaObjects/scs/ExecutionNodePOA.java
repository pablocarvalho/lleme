...
public abstract class ExecutionNodePOA extends org.omg.PortableServer.Servant
		implements uff.ic.lleme.letstalk.cbobjs.corbaObjects.scs.ExecutionNodeOperations,
	...
	public org.omg.CORBA.portable.OutputStream _invoke(String $method,
		...
		case 1: // corbaObjects/scs/ExecutionNode/startContainer
		{
			...
			} catch (uff.ic.lleme.letstalk.cbobjs.corbaObjects.scs.ContainerAlreadyExists $ex) {
				out = $rh.createExceptionReply();
				uff.ic.lleme.letstalk.cbobjs.corbaObjects.scs.ContainerAlreadyExistsHelper.write(out, $ex);
		...
		{
			uff.ic.lleme.letstalk.cbobjs.corbaObjects.scs.ContainerDescription $result[] = null;
			$result = this.getContainers();
			out = $rh.createReply();
			uff.ic.lleme.letstalk.cbobjs.corbaObjects.scs.ContainerDescriptionSeqHelper.write(out, $result);
			break;
		}

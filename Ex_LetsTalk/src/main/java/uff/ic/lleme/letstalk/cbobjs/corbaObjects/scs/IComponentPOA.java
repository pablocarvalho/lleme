...
public abstract class IComponentPOA extends org.omg.PortableServer.Servant
        implements uff.ic.lleme.letstalk.cbobjs.corbaObjects.scs.IComponentOperations,
        ...
        switch (__method.intValue()) {
            ...
            case 2: // corbaObjects/scs/IComponent/startup
            {
                try {
                    this.startup();
                    out = $rh.createReply();
                } catch (uff.ic.lleme.letstalk.cbobjs.corbaObjects.scs.StartupFailed $ex) {
                    out = $rh.createExceptionReply();
                    uff.ic.lleme.letstalk.cbobjs.corbaObjects.scs.StartupFailedHelper.write(out, $ex);
                }
                break;
            }
            ...
            case 3: // corbaObjects/scs/IComponent/shutdown
            {
                try {
                    this.shutdown();
                    out = $rh.createReply();
                } catch (uff.ic.lleme.letstalk.cbobjs.corbaObjects.scs.ShutdownFailed $ex) {
                    out = $rh.createExceptionReply();
                    uff.ic.lleme.letstalk.cbobjs.corbaObjects.scs.ShutdownFailedHelper.write(out, $ex);
                }
                break;
            }
            ...
            case 4: // corbaObjects/scs/IComponent/connect
            {
                try {
                    ...
                    out = $rh.createExceptionReply();
                    uff.ic.lleme.letstalk.cbobjs.corbaObjects.scs.InvalidNameHelper.write(out, $ex);
                } catch (uff.ic.lleme.letstalk.cbobjs.corbaObjects.scs.InvalidConnection $ex) {
                    out = $rh.createExceptionReply();
                    uff.ic.lleme.letstalk.cbobjs.corbaObjects.scs.InvalidConnectionHelper.write(out, $ex);
                } catch (uff.ic.lleme.letstalk.cbobjs.corbaObjects.scs.AlreadyConnected $ex) {
                    out = $rh.createExceptionReply();
                    uff.ic.lleme.letstalk.cbobjs.corbaObjects.scs.AlreadyConnectedHelper.write(out, $ex);
                } catch (uff.ic.lleme.letstalk.cbobjs.corbaObjects.scs.ExceededConnectionLimit $ex) {
                    out = $rh.createExceptionReply();
                    uff.ic.lleme.letstalk.cbobjs.corbaObjects.scs.ExceededConnectionLimitHelper.write(out, $ex);
                }
                break;
            }
            ...
            {
                try {
                    int id = uff.ic.lleme.letstalk.cbobjs.corbaObjects.scs.ConnectionIdHelper.read(in);
                    this.disconnect(id);
                    out = $rh.createReply();
                } catch (uff.ic.lleme.letstalk.cbobjs.corbaObjects.scs.InvalidConnection $ex) {
                    out = $rh.createExceptionReply();
                    uff.ic.lleme.letstalk.cbobjs.corbaObjects.scs.InvalidConnectionHelper.write(out, $ex);
                } catch (uff.ic.lleme.letstalk.cbobjs.corbaObjects.scs.NoConnection $ex) {
                    out = $rh.createExceptionReply();
                    uff.ic.lleme.letstalk.cbobjs.corbaObjects.scs.NoConnectionHelper.write(out, $ex);
                }
                break;
            }
            ...
            case 6: // corbaObjects/scs/IComponent/getConnection
            {
                try {
                    int id = uff.ic.lleme.letstalk.cbobjs.corbaObjects.scs.ConnectionIdHelper.read(in);
                    uff.ic.lleme.letstalk.cbobjs.corbaObjects.scs.ConnectionDescription $result = null;
                    $result = this.getConnection(id);
                    out = $rh.createReply();
                    uff.ic.lleme.letstalk.cbobjs.corbaObjects.scs.ConnectionDescriptionHelper
                            .write(out, $result);
                } catch (uff.ic.lleme.letstalk.cbobjs.corbaObjects.scs.InvalidConnection $ex) {
                    out = $rh.createExceptionReply();
                    uff.ic.lleme.letstalk.cbobjs.corbaObjects.scs.InvalidConnectionHelper.write(out, $ex);
            ...
            case 7: // corbaObjects/scs/IComponent/getConnections
            {
                try {
                    ...
                    out = $rh.createReply();
                    uff.ic.lleme.letstalk.cbobjs.corbaObjects.scs.ConnectionDescriptionsHelper.write(out,
                            $result);
                } catch (uff.ic.lleme.letstalk.cbobjs.corbaObjects.scs.InvalidName $ex) {
                    out = $rh.createExceptionReply();
                    uff.ic.lleme.letstalk.cbobjs.corbaObjects.scs.InvalidNameHelper.write(out, $ex);
            ...
            {
                uff.ic.lleme.letstalk.cbobjs.corbaObjects.scs.FacetDescription $result[] = null;
                $result = this.getFacets();
                out = $rh.createReply();
                uff.ic.lleme.letstalk.cbobjs.corbaObjects.scs.FacetDescriptionsHelper.write(out, $result);
                break;
            }
            ...
            {
                try {
                    String names[] = uff.ic.lleme.letstalk.cbobjs.corbaObjects.scs.NameListHelper.read(in);
                    uff.ic.lleme.letstalk.cbobjs.corbaObjects.scs.FacetDescription $result[] = null;
            ...
            {
                uff.ic.lleme.letstalk.cbobjs.corbaObjects.scs.ReceptacleDescription $result[] = null;
                $result = this.getReceptacles();
                out = $rh.createReply();
                uff.ic.lleme.letstalk.cbobjs.corbaObjects.scs.ReceptacleDescriptionsHelper.write(out, $result);
                break;
            }
            ...
            case 11: // corbaObjects/scs/IComponent/getReceptacleConnections
            {
                try {
                    ...
                    out = $rh.createExceptionReply();
                    uff.ic.lleme.letstalk.cbobjs.corbaObjects.scs.ExceededConnectionLimitHelper.write(out, $ex);
                } catch (uff.ic.lleme.letstalk.cbobjs.corbaObjects.scs.InternalError $ex) {
                    out = $rh.createExceptionReply();
                    uff.ic.lleme.letstalk.cbobjs.corbaObjects.scs.InternalErrorHelper.write(out, $ex);
                }
                break;
            }
            ...
            case 12: // corbaObjects/scs/IComponent/getReceptaclesByName
            {
                try {
                    ...
                    out = $rh.createReply();
                    uff.ic.lleme.letstalk.cbobjs.corbaObjects.scs.ReceptacleDescriptionsHelper.write(out,
                            $result);
                } catch (uff.ic.lleme.letstalk.cbobjs.corbaObjects.scs.InvalidName $ex) {
                    out = $rh.createExceptionReply();
                    uff.ic.lleme.letstalk.cbobjs.corbaObjects.scs.InvalidNameHelper.write(out, $ex);

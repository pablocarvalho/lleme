...
public class _NodeLookupStub extends org.omg.CORBA.portable.ObjectImpl
		implements uff.ic.lleme.letstalk.cbobjs.corbaObjects.scs.NodeLookup {

	public uff.ic.lleme.letstalk.cbobjs.corbaObjects.scs.NodeDescription getNode(String name) {
		org.omg.CORBA.portable.InputStream $in = null;
		try {
			org.omg.CORBA.portable.OutputStream $out = _request("getNode", true);
			$out.write_string(name);
			$in = _invoke($out);
			uff.ic.lleme.letstalk.cbobjs.corbaObjects.scs.NodeDescription $result = uff.ic.lleme.letstalk.cbobjs.corbaObjects.scs.NodeDescriptionHelper
					.read($in);
			return $result;
	...
	public uff.ic.lleme.letstalk.cbobjs.corbaObjects.scs.NodeDescription[] getNodes(
		...
		try {
			...
			$in = _invoke($out);
			uff.ic.lleme.letstalk.cbobjs.corbaObjects.scs.NodeDescription $result[] = uff.ic.lleme.letstalk.cbobjs.corbaObjects.scs.NodeDescriptionSeqHelper
					.read($in);
			return $result;
		} catch (org.omg.CORBA.portable.ApplicationException $ex) {
			$in = $ex.getInputStream();
	...
	public uff.ic.lleme.letstalk.cbobjs.corbaObjects.scs.NodeDescription[] getAllNodes() {
		org.omg.CORBA.portable.InputStream $in = null;
		try {

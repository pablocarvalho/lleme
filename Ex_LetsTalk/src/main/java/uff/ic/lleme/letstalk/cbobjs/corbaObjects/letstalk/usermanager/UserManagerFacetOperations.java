...
public interface UserManagerFacetOperations {
	uff.ic.lleme.letstalk.cbobjs.corbaObjects.letstalk.usermanager.enum_type subscribe(String login,
			String password);

	uff.ic.lleme.letstalk.cbobjs.corbaObjects.letstalk.usermanager.enum_type connect(String login,
			String password);

	uff.ic.lleme.letstalk.cbobjs.corbaObjects.letstalk.usermanager.enum_type desconnect(String login);

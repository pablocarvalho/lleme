...
abstract public class ConnectionDescriptionHelper {
		...
		if (__typeCode == null) {
			synchronized (org.omg.CORBA.TypeCode.class) {
				if (__typeCode == null) {
					...
					_tcOf_members0 = org.omg.CORBA.ORB.init().create_alias_tc(uff.ic.letstalk.corbaObjects.scs.ConnectionIdHelper.id(),
					...
					_members0[1] = new org.omg.CORBA.StructMember("objref",
							_tcOf_members0, null);
					__typeCode = org.omg.CORBA.ORB.init().create_struct_tc(uff.ic.letstalk.corbaObjects.scs.ConnectionDescriptionHelper.id(),
	...
	public static uff.ic.letstalk.corbaObjects.scs.ConnectionDescription read(
		...
		uff.ic.letstalk.corbaObjects.scs.ConnectionDescription value = new uff.ic.letstalk.corbaObjects.scs.ConnectionDescription();

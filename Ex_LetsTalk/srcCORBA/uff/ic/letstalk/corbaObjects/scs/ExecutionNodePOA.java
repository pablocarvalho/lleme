...
public abstract class ExecutionNodePOA extends org.omg.PortableServer.Servant
		implements uff.ic.letstalk.corbaObjects.scs.ExecutionNodeOperations,
	...
	public org.omg.CORBA.portable.OutputStream _invoke(String $method,
		...
		case 1: // corbaObjects/scs/ExecutionNode/startContainer
		{
			...
			} catch (uff.ic.letstalk.corbaObjects.scs.ContainerAlreadyExists $ex) {
				out = $rh.createExceptionReply();
				uff.ic.letstalk.corbaObjects.scs.ContainerAlreadyExistsHelper.write(out, $ex);
		...
		{
			uff.ic.letstalk.corbaObjects.scs.ContainerDescription $result[] = null;
			$result = this.getContainers();
			out = $rh.createReply();
			uff.ic.letstalk.corbaObjects.scs.ContainerDescriptionSeqHelper.write(out, $result);
			break;
		}

...
public abstract class ComponentLoaderPOA extends org.omg.PortableServer.Servant
        implements uff.ic.letstalk.corbaObjects.scs.ComponentLoaderOperations,
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String $method,
        ...
        switch (__method.intValue()) {
            case 0: // corbaObjects/scs/ComponentLoader/load
            {
                try {
                    uff.ic.letstalk.corbaObjects.scs.ComponentId id = uff.ic.letstalk.corbaObjects.scs.ComponentIdHelper
                            .read(in);
                    String args[] = uff.ic.letstalk.corbaObjects.scs.StringSeqHelper.read(in);
                    uff.ic.letstalk.corbaObjects.scs.ComponentHandle $result = null;
                    $result = this.load(id, args);
                    out = $rh.createReply();
                    uff.ic.letstalk.corbaObjects.scs.ComponentHandleHelper.write(out, $result);
                } catch (uff.ic.letstalk.corbaObjects.scs.ComponentNotFound $ex) {
                    out = $rh.createExceptionReply();
                    uff.ic.letstalk.corbaObjects.scs.ComponentNotFoundHelper.write(out, $ex);
                } catch (uff.ic.letstalk.corbaObjects.scs.ComponentAlreadyLoaded $ex) {
                    out = $rh.createExceptionReply();
                    uff.ic.letstalk.corbaObjects.scs.ComponentAlreadyLoadedHelper.write(out, $ex);
                } catch (uff.ic.letstalk.corbaObjects.scs.LoadFailure $ex) {
                    out = $rh.createExceptionReply();
                    uff.ic.letstalk.corbaObjects.scs.LoadFailureHelper.write(out, $ex);
                }
                break;
            }
            ...
            {
                try {
                    uff.ic.letstalk.corbaObjects.scs.ComponentHandle handle = uff.ic.letstalk.corbaObjects.scs.ComponentHandleHelper
                            .read(in);
                    this.unload(handle);
                    out = $rh.createReply();
                } catch (uff.ic.letstalk.corbaObjects.scs.ComponentNotFound $ex) {
            ...
            {
                uff.ic.letstalk.corbaObjects.scs.ComponentId $result[] = null;
                $result = this.getInstalledComponents();
                out = $rh.createReply();
                uff.ic.letstalk.corbaObjects.scs.ComponentIdSeqHelper.write(out, $result);
                break;
            }

...
public class _NodeLookupStub extends org.omg.CORBA.portable.ObjectImpl
		implements uff.ic.letstalk.corbaObjects.scs.NodeLookup {

	public uff.ic.letstalk.corbaObjects.scs.NodeDescription getNode(String name) {
		org.omg.CORBA.portable.InputStream $in = null;
		try {
			org.omg.CORBA.portable.OutputStream $out = _request("getNode", true);
			$out.write_string(name);
			$in = _invoke($out);
			uff.ic.letstalk.corbaObjects.scs.NodeDescription $result = uff.ic.letstalk.corbaObjects.scs.NodeDescriptionHelper
					.read($in);
			return $result;
	...
	public uff.ic.letstalk.corbaObjects.scs.NodeDescription[] getNodes(
			uff.ic.letstalk.corbaObjects.scs.Property[] props) {
		org.omg.CORBA.portable.InputStream $in = null;
		try {
			org.omg.CORBA.portable.OutputStream $out = _request("getNodes",
					true);
			uff.ic.letstalk.corbaObjects.scs.PropertySeqHelper.write($out, props);
			$in = _invoke($out);
			uff.ic.letstalk.corbaObjects.scs.NodeDescription $result[] = uff.ic.letstalk.corbaObjects.scs.NodeDescriptionSeqHelper
					.read($in);
			return $result;
		} catch (org.omg.CORBA.portable.ApplicationException $ex) {
			$in = $ex.getInputStream();
	...
	public uff.ic.letstalk.corbaObjects.scs.NodeDescription[] getAllNodes() {
		org.omg.CORBA.portable.InputStream $in = null;
		try {

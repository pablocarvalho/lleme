...
public class _UserFacetStub extends org.omg.CORBA.portable.ObjectImpl implements
        uff.ic.letstalk.corbaObjects.letstalk.UserFacet {
    ...
    public void subscribe(String login, String password)
        ...
        try {
            ...
            if (_id
                ...
                throw uff.ic.letstalk.corbaObjects.letstalk.InvalidSubscriptionValuesHelper
                        .read($in);
    ...
    public void disconnect(String login)
            throws uff.ic.letstalk.corbaObjects.scs.InvalidConnection, uff.ic.letstalk.corbaObjects.scs.NoConnection, uff.ic.letstalk.corbaObjects.scs.InternalError {
        org.omg.CORBA.portable.InputStream $in = null;
        try {
    ...
    public String[] listUsers() throws uff.ic.letstalk.corbaObjects.scs.InternalError {
        org.omg.CORBA.portable.InputStream $in = null;
        try {
            org.omg.CORBA.portable.OutputStream $out = _request("listUsers",
                    true);
            $in = _invoke($out);
            String $result[] = uff.ic.letstalk.corbaObjects.letstalk.stringListHelper.read($in);
            return $result;
        } catch (org.omg.CORBA.portable.ApplicationException $ex) {
            $in = $ex.getInputStream();
            String _id = $ex.getId();

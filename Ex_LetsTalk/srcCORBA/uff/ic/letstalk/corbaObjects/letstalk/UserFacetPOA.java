...
public abstract class UserFacetPOA extends org.omg.PortableServer.Servant
		implements uff.ic.letstalk.corbaObjects.letstalk.UserFacetOperations,
	...
	public org.omg.CORBA.portable.OutputStream _invoke(String $method,
		...
		case 0: // corbaObjects/letstalk/UserFacet/subscribe
		{
			try {
				...
				out = $rh.createReply();
			} catch (uff.ic.letstalk.corbaObjects.letstalk.InvalidSubscriptionValues $ex) {
				out = $rh.createExceptionReply();
				uff.ic.letstalk.corbaObjects.letstalk.InvalidSubscriptionValuesHelper.write(
						out, $ex);
		...
		case 3: // corbaObjects/letstalk/UserFacet/listUsers
		{
			try {
				...
				out = $rh.createReply();
				uff.ic.letstalk.corbaObjects.letstalk.stringListHelper.write(out, $result);
			} catch (uff.ic.letstalk.corbaObjects.scs.InternalError $ex) {
				out = $rh.createExceptionReply();
				uff.ic.letstalk.corbaObjects.scs.InternalErrorHelper.write(out, $ex);
			}

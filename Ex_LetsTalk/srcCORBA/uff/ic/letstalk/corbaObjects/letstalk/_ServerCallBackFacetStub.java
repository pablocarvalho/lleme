...
public class _ServerCallBackFacetStub extends org.omg.CORBA.portable.ObjectImpl
		implements uff.ic.letstalk.corbaObjects.letstalk.ServerCallBackFacet {
	...
	public void receiveMessage(String user, String chatId, String[] userId,
		...
		try {
			...
			uff.ic.letstalk.corbaObjects.letstalk.stringListHelper.write($out, userId);
	...
	public void updateDirectory() throws uff.ic.letstalk.corbaObjects.scs.InternalError {
		org.omg.CORBA.portable.InputStream $in = null;
		try {
			org.omg.CORBA.portable.OutputStream $out = _request(

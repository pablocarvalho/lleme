...
import uff.ic.letstalk.corbaObjects.scs.NodeLookup;
...
public class RegistryServant extends IComponentPOAImpl {
    ...
    private void initialize(ORB orb, RegistryStarter starter)
        ...
        uff.ic.letstalk.scs.registry.NodeRegisterServant facet1Servant = null;
        if (starter == null)
        ...
        uff.ic.letstalk.scs.registry.NodeLookupServant facet2Servant = new NodeLookupServant(
                facet1Servant);

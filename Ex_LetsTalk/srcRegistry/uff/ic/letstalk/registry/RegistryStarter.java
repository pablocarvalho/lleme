...
import uff.ic.letstalk.corbaObjects.scs.NodeLookupHelper;
...
public class RegistryStarter extends JFrame implements Runnable {
	...
	private void initialize() {
		...
		this.setSize(new java.awt.Dimension(183, 300));
	...
	public void startComponent() {
		...
		try {
			...
			uff.ic.letstalk.scs.registry.RegistryServant servant = new uff.ic.letstalk.scs.registry.RegistryServant(
					myOrb, this);

...
public abstract class PropertyPOA extends org.omg.PortableServer.Servant
		...
		uff.ic.corba.exemploAula.corbaClasses.PropertyOperations {
	...
	public uff.ic.corba.exemploAula.corbaClasses.Property _this() {
		return uff.ic.corba.exemploAula.corbaClasses.PropertyHelper.narrow(_this_object());
	}

	public uff.ic.corba.exemploAula.corbaClasses.Property _this(org.omg.CORBA.ORB orb) {
		return uff.ic.corba.exemploAula.corbaClasses.PropertyHelper

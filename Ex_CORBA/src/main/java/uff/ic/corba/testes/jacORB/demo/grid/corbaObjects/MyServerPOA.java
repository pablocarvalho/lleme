...
public abstract class MyServerPOA extends org.omg.PortableServer.Servant
		...
		uff.ic.corba.testes.jacORB.demo.grid.corbaObjects.MyServerOperations {
	...
	public uff.ic.corba.testes.jacORB.demo.grid.corbaObjects.MyServer _this() {
		return uff.ic.corba.testes.jacORB.demo.grid.corbaObjects.MyServerHelper
				.narrow(_this_object());
	}
	...
	public org.omg.CORBA.portable.OutputStream _invoke(String method,
		...
		case 1: // opWithException
		{
			...
			} catch (uff.ic.corba.testes.jacORB.demo.grid.corbaObjects.MyServerPackage.MyException _ex0) {
				_out = handler.createExceptionReply();
				uff.ic.corba.testes.jacORB.demo.grid.corbaObjects.MyServerPackage.MyExceptionHelper
						.write(_out, _ex0);
			}
			break;
		}
		case 2: // set
		{
			...
			java.math.BigDecimal _arg2 = uff.ic.corba.testes.jacORB.demo.grid.corbaObjects.MyServerPackage.fixedTHelper
					.read(_input);
			_out = handler.createReply();
		...
		case 3: // get
		{
			...
			short _arg1 = _input.read_short();
			_out = handler.createReply();
			uff.ic.corba.testes.jacORB.demo.grid.corbaObjects.MyServerPackage.fixedTHelper

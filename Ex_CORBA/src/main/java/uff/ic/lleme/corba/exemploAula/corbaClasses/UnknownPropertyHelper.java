...
public final class UnknownPropertyHelper {
	...
	public static org.omg.CORBA.TypeCode type() {
		if (_type == null) {
			_type = org.omg.CORBA.ORB
					.init()
					.create_exception_tc(uff.ic.lleme.corba.exemploAula.corbaClasses.UnknownPropertyHelper.id(),
							"UnknownProperty",
	...
	public static void insert(final org.omg.CORBA.Any any,
			final uff.ic.lleme.corba.exemploAula.corbaClasses.UnknownProperty s) {
		any.type(type());
		write(any.create_output_stream(), s);
	}

	public static uff.ic.lleme.corba.exemploAula.corbaClasses.UnknownProperty extract(
	...
	public static uff.ic.lleme.corba.exemploAula.corbaClasses.UnknownProperty read(
			final org.omg.CORBA.portable.InputStream in) {
		uff.ic.lleme.corba.exemploAula.corbaClasses.UnknownProperty result = new uff.ic.lleme.corba.exemploAula.corbaClasses.UnknownProperty();

...
public class _PropertyFactoryStub extends org.omg.CORBA.portable.ObjectImpl
		implements uff.ic.lleme.corba.exemploAula.corbaClasses.PropertyFactory {
	/**
	 * 
	 */
	...
	public final static java.lang.Class _opsClass = uff.ic.lleme.corba.exemploAula.corbaClasses.PropertyFactoryOperations.class;

	public uff.ic.lleme.corba.exemploAula.corbaClasses.Property[] getAll() {
		while (true) {
			if (!this._is_local()) {
				...
				try {
					org.omg.CORBA.portable.OutputStream _os = _request(
							"getAll", true);
					_is = _invoke(_os);
					uff.ic.lleme.corba.exemploAula.corbaClasses.Property[] _result = uff.ic.lleme.corba.exemploAula.corbaClasses.PropertySeqHelper
							.read(_is);
					return _result;
				...
				uff.ic.lleme.corba.exemploAula.corbaClasses.Property[] _result;
				try {
	...
	public uff.ic.lleme.corba.exemploAula.corbaClasses.Property get(java.lang.String name) {
		while (true) {
			if (!this._is_local()) {
				org.omg.CORBA.portable.InputStream _is = null;
				try {
					...
					_is = _invoke(_os);
					uff.ic.lleme.corba.exemploAula.corbaClasses.Property _result = uff.ic.lleme.corba.exemploAula.corbaClasses.PropertyHelper
							.read(_is);
					return _result;
				} catch (org.omg.CORBA.portable.RemarshalException _rx) {
				} catch (org.omg.CORBA.portable.ApplicationException _ax) {
	...
	public uff.ic.lleme.corba.exemploAula.corbaClasses.Property create(java.lang.String name,
			...
			if (!this._is_local()) {
				...
				try {
					...
					if (_id
						...
						throw uff.ic.lleme.corba.exemploAula.corbaClasses.PropertyAlreadyExistsHelper
			...
			if (!this._is_local()) {
				...
				try {
					...
					if (_id
						...
						throw uff.ic.lleme.corba.exemploAula.corbaClasses.UnknownPropertyHelper
								.read(_ax.getInputStream());
					}
					throw new RuntimeException("Unexpected exception " + _id);
				} finally {

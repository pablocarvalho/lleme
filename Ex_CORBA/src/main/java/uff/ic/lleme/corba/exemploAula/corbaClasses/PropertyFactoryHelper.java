...
public final class PropertyFactoryHelper {
	public static void insert(final org.omg.CORBA.Any any,
			final uff.ic.lleme.corba.exemploAula.corbaClasses.PropertyFactory s) {
		any.insert_Object(s);
	}

	public static uff.ic.lleme.corba.exemploAula.corbaClasses.PropertyFactory extract(
	...
	public static uff.ic.lleme.corba.exemploAula.corbaClasses.PropertyFactory narrow(
			final java.lang.Object obj) {
		if (obj instanceof uff.ic.lleme.corba.exemploAula.corbaClasses.PropertyFactory) {
			return (uff.ic.lleme.corba.exemploAula.corbaClasses.PropertyFactory) obj;
	...
	public static uff.ic.lleme.corba.exemploAula.corbaClasses.PropertyFactory narrow(
		...
		try {
			...
			if (obj._is_a("IDL:exemploAula/corbaClasses/PropertyFactory:1.0")) {
				uff.ic.lleme.corba.exemploAula.corbaClasses._PropertyFactoryStub stub;
				stub = new uff.ic.lleme.corba.exemploAula.corbaClasses._PropertyFactoryStub();
	...
	public static uff.ic.lleme.corba.exemploAula.corbaClasses.PropertyFactory unchecked_narrow(
			final org.omg.CORBA.Object obj) {
		if (obj == null)
			return null;
		try {

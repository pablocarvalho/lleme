...
public abstract class PropertyPOA extends org.omg.PortableServer.Servant
		...
		uff.ic.lleme.corba.exemploAula.corbaClasses.PropertyOperations {
	...
	public uff.ic.lleme.corba.exemploAula.corbaClasses.Property _this() {
		return uff.ic.lleme.corba.exemploAula.corbaClasses.PropertyHelper.narrow(_this_object());
	}

	public uff.ic.lleme.corba.exemploAula.corbaClasses.Property _this(org.omg.CORBA.ORB orb) {
		return uff.ic.lleme.corba.exemploAula.corbaClasses.PropertyHelper

...
public abstract class MyServerPOA extends org.omg.PortableServer.Servant
		...
		uff.ic.lleme.corba.testes.jacORB.demo.grid.corbaObjects.MyServerOperations {
	...
	public uff.ic.lleme.corba.testes.jacORB.demo.grid.corbaObjects.MyServer _this() {
		return uff.ic.lleme.corba.testes.jacORB.demo.grid.corbaObjects.MyServerHelper
				.narrow(_this_object());
	}
	...
	public org.omg.CORBA.portable.OutputStream _invoke(String method,
		...
		case 1: // opWithException
		{
			...
			} catch (uff.ic.lleme.corba.testes.jacORB.demo.grid.corbaObjects.MyServerPackage.MyException _ex0) {
		...
		case 2: // set
		{
			...
			java.math.BigDecimal _arg2 = uff.ic.lleme.corba.testes.jacORB.demo.grid.corbaObjects.MyServerPackage.fixedTHelper
					.read(_input);
			_out = handler.createReply();

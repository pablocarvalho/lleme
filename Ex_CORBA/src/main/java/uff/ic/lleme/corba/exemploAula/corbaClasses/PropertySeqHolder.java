...
public final class PropertySeqHolder implements
	...
	public uff.ic.lleme.corba.exemploAula.corbaClasses.Property[] value;

	public PropertySeqHolder() {
	}

	public PropertySeqHolder(final uff.ic.lleme.corba.exemploAula.corbaClasses.Property[] initial) {
		value = initial;
	}

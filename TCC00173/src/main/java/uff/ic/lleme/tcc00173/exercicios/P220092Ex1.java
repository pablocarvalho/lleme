...
public class P220092Ex1 {
  ...
  public static void main(String[] args) {
    ...
    System.out.println("Digite a taxa de varia��o da perfura��o: ");
    float taxa_perfuracao = in.nextFloat();
    System.out.println("Digite a taxa de varia��o do revestimento: ");
    float taxa_revestimento = in.nextFloat();
    System.out.println("valor b�sico da perfura��o: ");
    ...
    System.out.println("Quantidade de po�os: ");
    int n = in.nextInt();

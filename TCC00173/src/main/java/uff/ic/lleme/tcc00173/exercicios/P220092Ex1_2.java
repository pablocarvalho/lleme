...
public class P220092Ex1_2 {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(
            "O custo m�dio �:" + (custoPoco1 + custoPoco2 + custoPoco3) / 3);
  ...
  public static float recebeCalculaValor() {
    ...
    System.out.println("Insira o custo inicial de perfura��o");
    ...
    System.out.println("Insira a taxa de acr�scimo de perfura��o");
    float taxaPerfuracao = in.nextFloat();
    System.out.println("Insira a taxa de acr�scimo de revestimento");

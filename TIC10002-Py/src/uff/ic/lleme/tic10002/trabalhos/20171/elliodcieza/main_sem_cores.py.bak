...
class ArvoreBinariaBalanceada(object):
    ...
    def buscar(self):
        ...
        if op_busca == 2:
            filial_codigo_ini = -sys.maxint
            filial_codigo_fim = sys.maxint
...
while terminou_consulta is False:
    ...
    while op_valida is False:
        try:
            input_busca = input("Digite o numero da operacao de consulta que deseja realizar: ")
            ...
            print "ALERTA: Opcao invalida, tente novamente.\n"

    if op_busca == 1:
        while codigo_filial_ini_valido is False:
            try:
                filial_codigo_ini = input("\nDigite o codigo da filial X:  ")
                if type(filial_codigo_ini) is int:
                    codigo_filial_ini_valido = True
                else:
                    raise ValueError
            except ValueError:
                print "ALERTA: Codigo invalido, tente novamente."
            except (NameError, SyntaxError):
                print "ALERTA: Codigo invalido, insira apenas numeros."

        while codigo_filial_fim_valido is False:
            try:
                filial_codigo_fim = input("Digite o codigo da filial Y:  ")
        ...
        while data_ini_valida is False:
            try:
                ...
                print "ALERTA: Data invalida, tente novamente."
            except (NameError, SyntaxError, IndexError):
                print "ALERTA: Data invalida, insira apenas numeros."
        ...
        while codigo_vendedor_fim_valido is False:
            try:
                codigo_vendedor_fim = input("Digite o codigo do vendedor B:  ")
    ...
    while resposta_valida is False:
        try:
            ...
            print "ALERTA: Resposta invalida, responda apenas [Sim ou Nao]."

...
import uff.ic.biblioteca.oldmodel.CD;
...
import uff.ic.biblioteca.oldmodel.Login;
...
public class Load {
    ...
    public Load(Sistema sistema) {
        ...
        biblioteca.setNome("Inform�tica");
        ...
        livro.setCodigo(101);
        livro.setTitulo("UML Guia do Usu�rio");
        ...
        cd.setCodigo(300);
        cd.setTitulo("N�s vamos invadir a tua praia");
